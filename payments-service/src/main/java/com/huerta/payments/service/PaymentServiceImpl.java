...
import com.huerta.payments.dao.jpa.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public List<Payment> findAll() {
        return paymentRepository
                .findAll().stream().map(entity -> new Payment(entity.getId(), entity.getOrderId(),
                        entity.getProductId(), entity.getProductPrice(), entity.getProductQuantity()))
